...
#ifndef XChainZ_ZXCZTRACKER_H
#define XChainZ_ZXCZTRACKER_H
...
public:
    CzXCZTracker(std::string strWalletFile);
    ~CzXCZTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzXCZWallet* zXCZWallet = NULL);
