...
#ifndef XChainZ_ZXCZWALLET_H
#define XChainZ_ZXCZWALLET_H
...
public:
    CzXCZWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZXCZ(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZXCZ(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
