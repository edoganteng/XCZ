...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::XCZ);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeXChainZAmount"))
        SoftSetArg("-anonymizexchainzamount", settings.value("nAnonymizeXChainZAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in xchainz.cpp during shotdown to also remove the window positions
