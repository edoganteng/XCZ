                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzXCZPathCustom = GetArg("-zxczbackuppath", "");
    ...
    if(!strzXCZPathCustom.empty()) {
        ui->wallet_customzxczbackuppath->setText(QString::fromStdString(strzXCZPathCustom));
        ui->wallet_customzxczbackuppath_label->setVisible(true);
        ui->wallet_customzxczbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzXCZPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the XChainZ RPC console.") + "<br>" +
