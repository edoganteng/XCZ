...
/** Utility functions used by the XChainZ Qt UI.
 */
namespace GUIUtil
{
...
// Render XChainZ addresses in monospace font
...
// Parse "xchainz:" URI into recipient object, return true on successful parsing
