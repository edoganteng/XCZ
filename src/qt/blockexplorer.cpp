...
static std::string ValueToString(CAmount nValue, bool AllowNegative = false)
{
    ...
    QString Str = BitcoinUnits::formatWithUnit(BitcoinUnits::XCZ, nValue);
...
{
    std::string genesisblockhash = "00000da381d9331565ffa037c3647c56fddb6338575cb1ed52d996c15fc37f88";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (xchainz.conf).");
            QMessageBox::warning(this, "XChainZ Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#b3b4b5;}\n a, span { font-family: monospace; }\n span.addr {color:#b3b4b5; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #b3b4b5;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#b3b4b5;}\n a { color:#000; text-decoration:none; }\n a.nav {color:#b3b4b5;}\n";
