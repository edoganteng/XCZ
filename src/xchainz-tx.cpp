...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("XChainZ xchainz-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  xchainz-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xchainz transaction") + "\n" +
                               "  xchainz-tx [options] -create [commands]   " + _("Create hex-encoded xchainz transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded xchainz transaction
