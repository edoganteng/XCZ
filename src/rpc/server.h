...
/**
 * XChainZ RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue DoZxczSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
