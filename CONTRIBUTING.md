Contributing to XChainZ
============================

The XChainZ project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/xchainz-project/xchainz/blob/master/doc/translation_process.md)
...
The following applies to code changes to the XChainZ project, and is not to be
confused with overall XChainZ Network Protocol consensus changes.

Whether a pull request is merged into XChainZ rests with the project merge
...
Patches that change XChainZ consensus rules are considerably more involved than
...
Where a patchset proposes to change the XChainZ consensus, it must have been
...
The project leader is the release manager for each XChainZ release.
