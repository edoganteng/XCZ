...
from fake_stake.base_test import XChainZ_FakeStakeTest

class zXCZValidCoinSpendTest(XChainZ_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zXCZs..." % DENOM_TO_USE)
