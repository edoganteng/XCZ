...
RESOURCES += src/qt/xchainz.qrc src/qt/xchainz_locale.qrc

TRANSLATIONS += src/qt/locale/xchainz_bg.ts \
                src/qt/locale/xchainz_de.ts \
                src/qt/locale/xchainz_en.ts \
                src/qt/locale/xchainz_es.ts \
                src/qt/locale/xchainz_fi.ts \
                src/qt/locale/xchainz_fr.ts \
                src/qt/locale/xchainz_it.ts \
                src/qt/locale/xchainz_ja.ts \
                src/qt/locale/xchainz_pl.ts \
                src/qt/locale/xchainz_pt.ts \
                src/qt/locale/xchainz_ru.ts \
                src/qt/locale/xchainz_sk.ts \
                src/qt/locale/xchainz_sv.ts \
                src/qt/locale/xchainz_vi.ts \
                src/qt/locale/xchainz_zh_CN.ts \
                src/qt/locale/xchainz_zh_TW.ts
